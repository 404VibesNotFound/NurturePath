...
{
    /// <inheritdoc />
    public partial class EnhancedAuthenticationAndMessaging : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanViewMessages = table.Column<bool>(type: "boolean", nullable: false),
                    CanViewAppointments = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "PatientProviderRelationships",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientProviderRelationships", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PatientProviderRelationships_Users_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PatientProviderRelationships_Users_ProviderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientProviderRelationships_PatientId_ProviderId_Relations~",
                table: "PatientProviderRelationships",
                columns: new[] { "PatientId", "ProviderId", "RelationshipType" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PatientProviderRelationships_ProviderId",
                table: "PatientProviderRelationships",
                column: "ProviderId");

...
// Playwright configuration for NurturePath E2E testing
import { defineConfig, devices } from '@playwright/test';

/**
 * Configuration for Playwright Test
...
export default defineConfig({
  ...
  use: {
    ...
    baseURL: 'https://nuturepath.netlify.app/',
  ...
  projects: [
    {
      ...
      use: { 
        ...
        // Use headed browser for initial setup and debugging
        headless: false,
